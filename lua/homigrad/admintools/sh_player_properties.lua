...
properties.Add( "breakspine", {
	MenuLabel = "Break Spine", -- Name to display on the context menu
...
properties.Add( "breaktorso", {
	MenuLabel = "Paralyse Torso", -- Name to display on the context menu
...
properties.Add( "breakneck", {
	MenuLabel = "Paralyse Neck", -- Name to display on the context menu
